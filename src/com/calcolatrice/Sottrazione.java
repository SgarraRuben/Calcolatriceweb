...
/**
 * Servlet implementation class Sottrazione
 */
@WebServlet("/Sottrazione")
public class Sottrazione extends HttpServlet {
    ...
    private static double sottraiNumeri(double a,double b) {
		double s;
		s=a-b;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		double result = sottraiNumeri(valore1,valore2);
